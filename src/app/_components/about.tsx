        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6 mt-10">
            ...
            <div className="flex gap-2">
              <a href="#" className="bg-[#E84C3D] px-4 py-2 rounded-md flex items-center justify-center w-fit gap-2 text-white">
                <WhatsappLogo size={24} className="w-5 h-5" />
                Contato via WhatsApp
              </a>

              <a href="#" className="px-4 py-2 rounded-md flex items-center justify-center w-fit gap-2">
                <MapPin size={24} className="w-5 h-5" />
                Endereço da clínica
              </a>
            </div>
          </div>
